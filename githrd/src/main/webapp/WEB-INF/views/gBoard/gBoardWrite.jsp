...
<script type="text/javascript" src=/www/js/guestBoard/gboardWrite.js></script>
...
<body>
	<div class="w3-content mxw650 w3-margin-top">
		...
		<form method="POST" action="/www/gBoard/gBoardWriteProc.blp" name="frm" id="frm" class="w3-col w3-round-large w3-card-4 w3-margin-bottom w3-padding mgb20">
		...
		<div class="w3-col w3-card-4">
			<div class="w3-third w3-button w3-green w3-hover-lime" id="listlbtn">list</div>
