...
<body>
	<div class="w3-content mxw750 w3-margin-top">
		...
		<header class="w3-col w3-card-4 mgb20">
			<h1 class="w3-pink w3-center w3-padding mg0">BlackPink 게시글 수정</h1>
			...
			<div class="w3-col w3-round-large w3-card-4 w3-margin-bottom w3-padding">
				...
				<div class="w3-rest w3-padding">
					...
					<input type="hidden" id="obody" value="${DATA.body}">
						<form method="POST" action="/whistle/reboard/reboardEditProc.blp" id="frm" name="frm" class="w3-col w3-margin-top">
							<input type="hidden" id="nowPage" name="nowPage" value="${param.nowPage}">
							<input type="hidden" id="bno" name="bno" value="${DATA.bno}">
							<textarea class="w3-col w3-padding ft12" id="body" rows="3" name="body" style="resize: none;">${DATA.body}</textarea>
						</form>
