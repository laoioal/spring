...
<%--
 ...
 --%>
			<div class="box w150 w3-button w3-blue ml10 mb5">${data.ID}</div>
			<div class="box w150 w3-button w3-blue ml10 mb5">${data.MAIL}</div>
			<div class="box w150 w3-button w3-blue ml10 mb5">${data.ANO}</div>
</c:forEach>		
		</div>
		<div class="w3-col w3-margin-top">
