...
public class PageUtil {
	...
	public PageUtil(int nowPage, int totalPage, int pageRow, int pageGroup) {
	...
	public void setTotalPage() {
		/*
			총 페이지수는 총 게시물 수를 한 화면에 표시할 게시물 개수(pageRow)로 나무면 된다.
	...
	public void setStartPage() {
		...
		// 11 - 1 / 3 ==> 3
		//					3 * 3 = 9 + 1 ==> 시작페이지
		// ==> 현재 페이지에서 -1을 해주고 거기에 한 화면에 보여질 이동 가능한 페이지 수(pageGroup)로 나누고
